                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="menuForm" method="post" action="" onsubmit="return check_add();">                        
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input value="{{$row->type}}"  type="text" class="form-control" name="type" id="type">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input value="{{$row->type_name}}"  type="text" class="form-control" name="type_name" id="type_name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input value="{{$row->cost}}" type="text" class="form-control" name="cost" id="cost">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <input type="text" value="update" id="status" name="status" hidden>
                                            <button class="btn btn-primary" type="submit" name="signup" value="Create">บันทึกข้อมูล</button>
                                            <a class="btn btn-danger" href="{{url("$segment/$folder")}}">ยกเลิก</a>
                                        </div>
                                    </form>
