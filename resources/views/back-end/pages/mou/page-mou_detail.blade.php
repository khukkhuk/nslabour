    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Mou</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ url("$segment") }}">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ข้อมูลการดำเนินการ Mou</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">ข้อมูลการดำเนินการ Mou</h4>
                                    ...
                                    <div hidden id="add_detail" class="row">
                                        <div  class="col-3 text-center" style="margin: 15px 0px;margin-left:34%;background-color:#f8f9fa;padding:5px;border-radius:5px;">
                                            <form action="webpanel/mou/mou_detail" method="post">
                                                ...
                                                <input type="text" hidden value="{{$result->id}}" id="title_id" name="title_id">
                                    ...
                                    <table id="sort_table" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width:10%" class="text-center">รับโดย</th>
                                            <!-- <th style="width:10%" class="text-center">วันที่ส่ง</th> -->
                                            <th style="width:10%" class="text-center">แก้ไขโดย</th>
                    ...
                    <div class="card" id="div_show" hidden>
                        ...
                        <div>
                            <form action="webpanel/mou/mou_detail" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                                                    @csrf
