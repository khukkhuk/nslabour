    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">จัดทำ MOU </h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <select class="form-control" required name="select_type" id="select_type">
                                        ...
                                        <option value="ทำเล่มใหม่">ทำเล่มใหม่</option>
                                        <option value="เปลี่ยนเล่ม">เปลี่ยนเล่ม</option>
                                        <option value="ติดVisa">ติดVisa</option>
                                    </select>
                                                </div>
