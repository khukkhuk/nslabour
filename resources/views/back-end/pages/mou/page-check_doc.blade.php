    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">ข้อมูลMou</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ url("$segment") }}">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ข้อมูลMou(ตรวจสอบเอกสาร) </li>
                    </ol>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">ข้อมูลMou</h4>
                                    </p>
                                    ...
                                    <table id="data-tablecheckdoc" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;"></table>
                        ...
                        <form id="formnote" action="" method="post">
                            ...
                            <textarea name="notes" hidden class="form-control" id="notes" cols="80" rows="6" placeholder="แสดงความคิดเห็น"></textarea>
                            <center><input type="submit" id="btn_form" hidden class="btn btn-success" value="ยืนยันการส่งข้อมูล">
                        </form>
                </div>
            </div>
        </div> <!-- end col -->
