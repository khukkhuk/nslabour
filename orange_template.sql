...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2021 at 12:12 PM
...
--
-- Table structure for table `log_backend`
--

CREATE TABLE `log_backend` (
  `id` int(11) NOT NULL,
  `auth_id` int(5) DEFAULT NULL,
  `type_status` enum('success','error') DEFAULT NULL,
  `error_log` text DEFAULT NULL,
  `error_line` int(11) DEFAULT NULL,
  `error_url` text DEFAULT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='InnoDB free: 8192 kB' ROW_FORMAT=DYNAMIC;
...
(1, 'admin', 'Pipat', 'Administrator', NULL, '$2y$12$82.kCAuL2nPig0GNAS5sqeEz/3/JbvaMybMpH7PvvB57p2TGCF/H.', NULL, 'active', NULL, '2020-02-04 01:04:15', '2021-04-08 20:11:27');
...
--
-- Indexes for table `log_backend`
--
ALTER TABLE `log_backend`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `log_backend`
--
ALTER TABLE `log_backend`
