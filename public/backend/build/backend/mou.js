var fullUrl = window.location.origin + '/webpanel/mou';
...
$(function () {
    oTable = $('#data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'name_th',    title :'ชื่อแรงงาน',    className: 'text-center w30'}, //4
        ...
        rowCallback: function (nRow, aData, dataIndex) {
            ...
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="'+segment+'/'+folder+'/detail/'+aData["mou_id"]+'"class="btn btn-sm btn-success">ดูข้อมูล</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="'+segment+'/'+folder+'/edit/'+aData["mou_id"]+'"class="btn btn-sm btn-success">แก้ไขข้อมูล</a></div>'
            ).addClass('input');
    ...
    oTable = $('#data-tablecheckdoc').DataTable({
        "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-'p>>",
        processing: true,
        serverSide: true,
        stateSave: true,
        ...
        columns: [
            {data: 'DT_RowIndex',    title :'#',    className: 'text-center w10'}, // 0
            {data: 'created',    title :'วันที่',    className: 'text-center w30'}, // 1
            {data: 'type_name',    title :'รายการ',    className: 'text-center w30'}, //2
            {data: 'name',    title :'แรงงาน',    className: 'text-center w30'}, //3
            {data: 'created_by',    title :'คนรับงาน',    className: 'text-center w30'}, //4
            {data: 'updated',    title :'แก้ไขล่าสุด',    className: 'text-center w30'}, //4
            {data: 'id',    title :'จัดการ',    className: 'text-center w30'}, //4
            ],
        rowCallback: function (nRow, aData, dataIndex) {
            $('td:eq(1)', nRow).html(''
            + aData['created'].substr(0, 10),
            ).addClass('input');
            ...
            $('td:eq(6)', nRow).html(''
             +'<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample'+dataIndex+'" aria-expanded="false" aria-controls="collapseExample">ดำเนินการ</button>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="'+segment+'/'+folder+'/detail/'+aData["mou_id"]+'" disabled class="btn btn-sm btn-success">ดูเอกสาร</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" onclick="formnote('+aData['mou_id']+')" class="btn btn-sm btn-success">หมายเหตุ</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" onclick="confirm_check('+aData['mou_id']+')" class="btn btn-sm btn-success">ยืนยันการตรวจสอบ</a></div>'
           ).addClass('input');

            // $('td:eq(9)', nRow).html(''
            // +'<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample'+dataIndex+'" aria-expanded="false" aria-controls="collapseExample">ดำเนินการ</button>'
            // +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="'+segment+'/'+folder+'/detail/'+aData["id"]+'"class="btn btn-sm btn-success">ดูข้อมูล</a></div>'
            // +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="'+segment+'/'+folder+'/edit/'+aData["id"]+'"class="btn btn-sm btn-success">แก้ไขข้อมูล</a></div>'
            // ).addClass('input');
    ...
    oTable = $('#data-table-status').DataTable({
        "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-'p>>",
        processing: true,
        serverSide: true,
        stateSave: true,
        ...
        iDisplayLength: 25,
        ajax: {
            url: "webpanel/mou/tb_mou_status",
            data: function (d) {
                d.Like={};
                $('.myLike').each(function() {
                if( $.trim($(this).val()) && $.trim($(this).val()) != '0' ){
        ...
        columns: [
            ...
            {data: 'type_name',    title :'รายการ',    className: 'text-center w30'}, //2
            {data: 'created_by',    title :'คนรับงาน',    className: 'text-center w30'}, //4
            {data: 'created',    title :'วันที่รับงาน',    className: 'text-center w30'}, // 1
            {data: 'updated',    title :'แก้ไขล่าสุด',    className: 'text-center w30'}, //4
            {data: 'id',    title :'',    className: 'text-center w30'}, // 1
            ],
        rowCallback: function (nRow, aData, dataIndex) {
            $('td:eq(1)', nRow).html(''
            + aData['type_name'],
            ...
            $('td:eq(3)', nRow).html(''
            + aData['created_title'].substr(0, 10), 
            ).addClass('input');

            if(aData['updated_title']==null){
                updated="-"
            }else{
                updated=aData['updated_title'].substr(0, 10)
            }
            $('td:eq(4)', nRow).html(''
            + updated, 
            ).addClass('input');
            ...
            $('td:eq(5)', nRow).html(''
            // +'<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample'+dataIndex+'" aria-expanded="false" aria-controls="collapseExample">ดำเนินการ</button>'
            // +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="'+segment+'/'+folder+'/mou_detail/'+aData["mou_id"]+'" class="btn btn-sm btn-success">ดูรายละเอียดการดำเนินการ</a></div>'
            +'<a style="width:70%;margin:5px 0px" href="'+segment+'/'+folder+'/mou_detail/'+aData["mou_id"]+'" class="btn btn-sm btn-success">ดูรายละเอียดการดำเนินการ</a>'
            
            // +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" onclick="note('+aData['mou_id']+')" class="btn btn-sm btn-success">หมายเหตุ</a></div>'
            ).addClass('input');
    ...
    $("#province_edit").html($("#select_p_th").val());
    $("#district_edit").html($("#select_d_th").val());
    $("#subdistrict_edit").html($("#select_sd_th").val());
        ...
        success: function () {
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    setTimeout(function(){
                        window.location.href = "webpanel/mou/mou_detail/"+$("#mou_id").val();
                    },1000);
                }
...
function confirm_check(id){
    $.ajax({ type: 'get', 
        url: "webpanel/mou/confirmcheck/"+id,
        success: function (res) {
                $("#formnote").html(res);     
        } 
    });
