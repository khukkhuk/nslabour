var fullUrl = window.location.origin + '/webpanel/follower';
...
$(function () {
    ...
    oTable = $('#data-table').DataTable({
        ...
        ajax: {
            ...
            url: "webpanel/follower/datatable/"+em,
            data: function (d) {
                d.Like={};
        ...
        columns: [
            ...
            {data: 'age',    title :'อายุ',    className: 'text-center w70'}, //2
            {data: 'employee_id',    title :'ผู้ติดตาม',    className: 'text-center w30'}, //3
        ...
        rowCallback: function (nRow, aData, dataIndex) {
        	...
        	+ ' <a href="javascript:" class="btn btn-sm btn-danger" onclick="destroy('+aData["id"]+')" data-id="'+aData["id"]+'" title="Edit"><i class="far fa-trash-alt"></i></a>'
			).addClass('input');
        }
    });
